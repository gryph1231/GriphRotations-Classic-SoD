...
--             config2_0:SetChecked(GriphRH.db.profile.mainOption.debug)
...
--             local ic_3_0 = StdUi:Slider(tab.frame, 125, 16, GriphRH.db.profile.mainOption.mainIconOpacity, false, 0, 100)
--             StdUi:GlueBelow(ic_3_0, ic_2_0, 0, -24, 'LEFT');
--             local config3_1Label = StdUi:FontString(tab.frame, "Icon Opacity: " .. GriphRH.db.profile.mainOption.mainIconOpacity)
...
--                 GriphRH.db.profile.mainOption.mainIconOpacity = value
--                 ic_3_0 = value
--                 config3_1Label:SetText("Icon Opacity: " .. GriphRH.db.profile.mainOption.mainIconOpacity)
--             end

--             local ic_3_1 = StdUi:Slider(tab.frame, 125, 16, GriphRH.db.profile.mainOption.mainIconScale / 10, false, 5, 75)
--             StdUi:GlueBelow(ic_3_1, ic_2_1, 0, -24, 'RIGT');
--             local config3_1Label = StdUi:FontString(tab.frame, "Icon Size: " .. GriphRH.db.profile.mainOption.mainIconScale)
...
--                 GriphRH.db.profile.mainOption.mainIconScale = value
--                 ic_3_1 = value
--                 config3_1Label:SetText("Icon Size: " .. GriphRH.db.profile.mainOption.mainIconScale)
--             end
...
--                 local enabled = "True"
--                 if GriphRH.db.profile.mainOption.disabledSpells[spellID] == true then
--                     enabled = "False"
--                 end
...
--                     if GriphRH.db.profile.mainOption.disabledSpells[spellID] ~= nil then
--                         GriphRH.db.profile.mainOption.disabledSpells[spellID] = nil
--                         data[st:GetSelection()].enabled = "True"
--                         print("Removed: " .. GetSpellLink(spellID))
--                     else
--                         GriphRH.db.profile.mainOption.disabledSpells[spellID] = true
...
--                     --GriphRH.SpellBlocker(nil, point, relativeTo, relativePoint, xOfs, yOfs)
--                     --
...
--                     for key, Spell in pairs(GriphRH.Spell[GriphRH.playerClass]) do
--                         if Spell:ID() == SpellDATA.spellId then
--                             SpellVAR = key
--                         end
--                     end
--                     GriphRH.print("Macro for: " .. GetSpellLink(SpellDATA.spellId) .. " was created. Check your Character Macros.")
...
--             for i, spell in pairs(GriphRH.db.profile.mainOption.interruptList) do
...
--                 if tempAddSpell ~= 0 and GriphRH.db.profile.mainOption.interruptList[tempAddSpell] == nil then
--                     GriphRH.db.profile.mainOption.interruptList[tempAddSpell] = true
--                 end
...
--                     GriphRH.playSoundR("Interface\\Addons\\Griph-RH\\Media\\button.ogg")
--                     GriphRH.db.profile.mainOption.interruptList[selectedSpell] = nil
--                     selectedSpell = nil
...
--             local whiteListText = (GriphRH.db.profile.mainOption.whiteList == true and 'Whitelist' or 'Blacklist')
...
--                 GriphRH.db.profile.mainOption.whiteList = (val == "Whitelist" and true or false)
--                 whiteListText = (GriphRH.db.profile.mainOption.whiteList == true and 'Whitelist' or 'Blacklist')
...
--             ic_2_1:SetChecked(GriphRH.db.profile.mainOption.whiteList)
--             function ic_2_1:OnValueChanged(self, state, value)
--                 if GriphRH.db.profile.mainOption.whiteList then
--                     GriphRH.db.profile.mainOption.whiteList = false
--                 else
--                     GriphRH.db.profile.mainOption.whiteList = true
--                 end
--             end
--         end
...
-- function GriphRH.SpellBlocker(spellID, point, relativeTo, relativePoint, xOfs, yOfs)
--     if spellID ~= nil then
--         if GriphRH.db.profile.mainOption.disabledSpells[spellID] ~= nil then
--             GriphRH.db.profile.mainOption.disabledSpells[spellID] = nil
--             print("Removed: " .. GetSpellLink(spellID))
...
-- function GriphRH.ClassConfig(specID)
--     AllMenu('secondTab')
-- end
