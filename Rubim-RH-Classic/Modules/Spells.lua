...
RubimRH.Spell[7] = {
    ...
    HealingWave = Spell(547),
	FlameTongueWeapon = Spell(8024),
    StoneskinTotem = Spell(8071),
    StrengthofEarthTotem = Spell(8075),
    LightningShield = Spell(324),
    EarthbindTotem = Spell(2484),
    StoneclawTotem = Spell(5730),
