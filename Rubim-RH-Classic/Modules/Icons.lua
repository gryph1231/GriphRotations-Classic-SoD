...
UIDropDownMenu_Initialize(dropDown, function(self, level, menuList)
    ...
    if (level or 1) == 1 then
        ...
        info.func = function(self)
            RubimRH.ClassConfig(RubimRH.playerClass)
            RubimRH.playSoundR("Interface\\Addons\\Rubim-RH\\Media\\button.ogg")
        end
        UIDropDownMenu_AddButton(info)
        --
        if RubimRH.playerClass == 65 then
...
function updateIcon:onUpdate(sinceLastUpdate)
    ...
    if (self.sinceLastUpdate >= 0.066) then
        ...
        if RubimRH.db.profile.mainOption.burstCD and RubimRH.db.profile[RubimRH.playerClass].cooldown then
        ...
        local singleRotation = RubimRH.mainRotation("SingleTarget")
